...
If you are having issues with a modified theme, try using this version.
This version contains additional triggers to fire the `wooAlignButtons();` script.
This is not guaranteed to resolve your theme issues and will use extra resources.
