...
This version will also align your Product Titles, which will allow you to have longer titles or larger fonts.
...
* The new script is Global, so it can be called within other Plugins
